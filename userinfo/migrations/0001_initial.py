...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('userinfo', ['User'])


    def backwards(self, orm):
        # Deleting model 'User'
        db.delete_table('userinfo_user')
    ...
    models = {
        ...
        'userinfo.user': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile_image': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
